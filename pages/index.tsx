  ...
  return (
    <main className={styles.main}>
      ...
      <p className={styles.description}>
        Welcome to the only online home built just for tradespeople. Connect, share your craft, find
        jobs, and join a real community that values skilled hands.
      </p>
      ...
      <footer className={styles.footer}>Made for Tradesmen, by Tradesmen</footer>
      {/*
